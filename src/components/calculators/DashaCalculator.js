...
//     e.preventDefault();
//     try {
//       const res = await axios.post("https://adminastrotalk-1.onrender.com/api/calculators/dasha", {
//         dob,
//         tob,
//         pob,
//       });
...
//         <input type="text" placeholder="Place of Birth" value={pob} onChange={(e) => setPob(e.target.value)} required />
//         <button type="submit">Get Dasha</button>
//       </form>
