...
export default function TemplateEditor({ onSaved }) {
  ...
  return (
    <div style={{ background: "#1e293b", padding: 20, borderRadius: 10, color: "#fff", maxWidth: 600, margin: "auto" }}>
...
const styles = {
  input: { width: "100%", padding: 8, marginBottom: 10, borderRadius: 6, border: "1px solid #334155", background: "#0f172a", color: "#e2e8f0" },
